...
CREATE INDEX idx_staff_shift_streak ON staff_shift (AMKA, shift_type, date);
...
CREATE INDEX idx_prescription_allergy_check ON prescription (AMKA_patient, medicine_name);
...
CREATE INDEX idx_AMKA_provider_name ON patient_insurance (AMKA, provider_name);
